Chart.defaults.global.defaultFontFamily =
  ...
  $.ajax({/*Enviar requisição e obter */
      type: "POST",/*Tipo de requisição */
      url: "../../Model/Dashboard/ChartBarSms.php",/*Aonde vai estar a ligação com o banco de dados */
      dataType: "json",/*Qual objeto que irei querer receber */
      success: function (data) {/*Informações que irei receber */
          ...
          var used = [];
          var months = [];
          var fullMonths = ["Jan","Fev","Mar","Abr","Mai","Jun","Jul","Ago","Set","Out","Nov","Dez"];//criando array para colocar os meses por extenso porém abreviado
          for (var i = 0; i < data.length; i++) {//pegando os dados do data
          ...
          graficBarSms(months,used);//montado o chart com as informações passadas
      }

  });

function graficBarSms(months,used){
